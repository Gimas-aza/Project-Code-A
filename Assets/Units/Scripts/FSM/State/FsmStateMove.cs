...
public class FsmStateMove : FsmState
{
    ...
    public FsmStateMove(Fsm fsm, PlayerUnit player, NavMeshAgent navMeshAgent, float pursueDistance, float attackDistance) : base(fsm)
    {
        _fsm = fsm;
        _player = player;
    ...
    public override void Update()
    {
        ...
        if (Vector3.Distance(_player.transform.position, _navMeshAgent.transform.position) < _attackDistance)
        {
